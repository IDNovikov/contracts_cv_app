...
export interface GetAuthDataByUserIdRequest {
  userId: string;
}
...
export interface AuthServiceClient {
  ...
  getAuthDataByUserId(request: GetAuthDataByUserIdRequest): Observable<AuthDataResponse>;
}
...
export interface AuthServiceController {
  ...
  ): Promise<AuthDataResponse> | Observable<AuthDataResponse> | AuthDataResponse;
}
